      ...
      <form action="" className='w-full lg:w-1/2 h-full bg-white rounded rounded-l-none flex flex-col justify-center'>
        ...
        <div className='flex flex-col items-center w-full'>
            ...
            <div className='w-96 flex shadow-sm my-1'>
                <input type="text" className=' w-full p-3 rounded rounded-r-none border-r-0 bg-gray-50 outline-none border-2 duration-100 text-sm text-gray-400' placeholder='Full Name'/>
        ...
        <div className='flex flex-col items-center w-full my-8 text-sm'>
          <button type='button' className='p-3 w-96 bg-blue-500 hover:bg-blue-600 duration-200 mx-auto text-white rounded my-1'>Sign Up</button>
          ...
          <button type='button' className='p-3 w-96 bg-white border-2 border-gray-200 hover:border-gray-300 duration-200 mx-auto text-gray-400 rounded my-1'>Sign In with Github</button>
        </div>
